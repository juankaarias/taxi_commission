<?php
    $titulo="Centro de ayuda - Configuración";
                ...
                <section class="info__temas">
                    <div class="info__header">
                        ...
                        <div class="header__help">
                            <h1 class="help__titulo">Preguntas Frecuentes / Configuración</h1>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <section class="temas__acordeon" >
                        <div class="acordeon">
                            <div class="bloque">   
                                ...
                                <p class="p"><i class="opcion__iconomenu fa-solid fa-user-plus"></i> Copia de Seguridad</p>
