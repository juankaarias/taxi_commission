    ...
    <footer class="footer">
            ...
            <section class="contenedor__direccion">
                ...
                <section class="direccion__texto">
                    <section class="texto__direccion">
                        <p class="direccion__title">Taxi Rodadero Central, CC ARRECIFE</p>
                    </section>
                    <section class="texto__direccion">
                        <p class="direccion__info">Cra 4 N° 11A &#45; 119 Rodadero Santa Marta, Magdalena.</p>
                        <p class="direccion__tel"><strong>Teléfonos: &#40;605&#41; 4225830 - &#40;605&#41; 4227255</strong></p>
                    </section>
                </section>
            </section>
            <section class="contenedor__direccion">
                ...
                <section class="direccion__texto">
                    <section class="texto__direccion">
                        <p class="direccion__title">Sucursal Bello Horizonte, Al lado del Hotel Zuana Beach</p>
                    </section>
                    <section class="texto__direccion">
                        <p class="direccion__info">Calle 125 con Carrera 3 Santa Marta, Magdalena</p>
                        <p class="direccion__tel">Teléfonos: &#40;605&#41; 4321600 - &#40;605&#41; 4322900</p>
                    </section>
                </section>
            </section>
        </section>
        ...
        <section class="footer__copy">
            <p class="copy__autor">&copy; 2022 Taxi Rodadero Bello Horizonte S.A.S - Todos los derechos reservados</p>
        </section>
    </footer>
