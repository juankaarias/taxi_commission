<?php
    $titulo="Centro de ayuda - Usuarios";
                ...
                <section class="info__temas">
                    <div class="info__header">
                        ...
                        <div class="header__help">
                            <h1 class="help__titulo">Preguntas Frecuentes / Usuarios</h1>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <section class="temas__acordeon" >
                        <div class="acordeon">
                            <div class="bloque">   
                                ...
                                <p class="p"><i class="opcion__iconomenu fa-solid fa-user-plus"></i> Crear Usuario</p>
                            ...
                            <div class="bloque">
                                <i class="bloque__icon fa-solid fa-plus"></i>
                                <p class="p"><i class="opcion__iconomenu fa-solid fa-address-book"></i> Consultar Usuario</p>
