<?php
    $titulo="Centro de ayuda - Usuario Logueado";
                ...
                <section class="info__temas">
                    <div class="info__header">
                        ...
                        <div class="header__help">
                            <h1 class="help__titulo">Preguntas Frecuentes / Usuario Logueado</h1>
                            <p></p>
                        </div>
                    </div>
                    ...
                    <section class="temas__acordeon" >
                        <div class="acordeon">
                            <div class="bloque">   
                                ...
                                <p class="p"><i class="opcion__iconomenu fa-regular fa-address-card"></i> Perfil Usuario</p>
                            ...
                            <div class="bloque">   
                                <i class="bloque__icon fa-solid fa-plus"></i>
                                <p class="p"><i class="opcion__iconomenu fa-solid fa-key"></i> Cambiar Contraseña</p>
                                <p class="contenido">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia magnam, explicabo libero eaque provident adipisci similique laudantium ea reprehenderit vitae quo autem odio deserunt ut dolor eius? Magnam, dolore est.</p>
                            </div>
                            <div class="bloque">   
                                <i class="bloque__icon fa-solid fa-plus"></i>
                                <p class="p"><i class="opcion__iconomenu fa-solid fa-power-off"></i> Cerrar Sesión</p>
                                <p class="contenido">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia magnam, explicabo libero eaque provident adipisci similique laudantium ea reprehenderit vitae quo autem odio deserunt ut dolor eius? Magnam, dolore est.</p>
                            </div>
                        </div>
                    </section>
